...
// An ordered slice made of Image structs. Represents a flat dependency tree.
...
// Returns the pwl at the lower level for the branch where img[pos] lives.
...
// Return the ACIFiles struct for the given image. All file outside rootfs are
// excluded (at the moment only "manifest").
...
// If pwl length is 0, return a nil map
