...
// Use acirender_test package name and dot import acirenderer to avoid circular
// dependencies between cas and acirenderer tests.
...
func TestGetUpperPWLM(t *testing.T) {
	...
	//l2pwl1 := []string{"/a/path/white/list/level2/1"}

	l0pwl1m := pwlToMap(l0pwl1)
	//l1pwl1m := pwlToMap(l1pwl1)
	//l2pwl1m := pwlToMap(l2pwl1)
